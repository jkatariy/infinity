...
const AboutUs = () => {
  ...
  const impactStats = [
    ...
    },
    {
      ...
      description: 'Consistent growth since 2016',
      icon: (
        <svg className="h-8 w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const achievements = [
    {
      ...
      description: 'Preferred partner for leading brands like MARS, Unilever, and Everest Spices',
      highlight: 'Fortune 500 Clients'
    },
    {
      title: 'Quality Excellence',
      description: 'ISO 9001:2015 certified with consistent quality standards',
      highlight: 'ISO Certified'
    },
    {
      title: 'Innovation Focus',
      description: 'Continuous R&D investment in cutting-edge packaging automation',
      highlight: 'Future-Ready'
    },
    {
      title: 'Global Reach',
      description: 'Expanding presence across international markets',
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Milestones that define our journey towards packaging automation excellence
            </p>
          </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {achievements.map((achievement, index) => (
              <motion.div
                ...
                className="relative group"
              >
                <div className="bg-gradient-to-br from-white to-gray-50 border border-gray-200 p-6 h-full relative group hover:shadow-lg transition-all duration-300 overflow-hidden">
                  {/* Animated background */}
                  ...
                  <div className="absolute top-0 left-0 w-16 h-16 pointer-events-none">
                    <div className="absolute top-0 left-0 w-0.5 h-8 bg-blue-500 transform origin-top scale-y-0 transition-transform group-hover:scale-y-100 duration-500"></div>
                    <div className="absolute top-0 left-0 h-0.5 w-8 bg-blue-500 transform origin-left scale-x-0 transition-transform group-hover:scale-x-100 duration-500"></div>
                  </div>
                  
                  <div className="relative z-10">
                    <div className="inline-block bg-blue-600 text-white px-3 py-1 text-xs font-semibold mb-4 group-hover:bg-blue-700 transition-colors duration-300">
