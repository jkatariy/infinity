...
const allModels: Record<string, ProductModel[]> = {
  ...
  'cartoning': [
    { name: 'ACM-100', title: 'ACM-100 Automatic Cartoning Machine', subtitle: 'Continuous Motion System', href: '/products/cartoning/acm-100', image: 'https://res.cloudinary.com/dbogkgabu/image/upload/v1755098774/sqcbuioldiwnkfxjxo3l.png', highlight: 'Continuous Motion' },
    { name: 'ACM-40', title: 'ACM-40 Semi Automatic Cartoning Machine', subtitle: 'Semi-Automatic Operation', href: '/products/cartoning/acm-40', image: 'https://res.cloudinary.com/dbogkgabu/image/upload/v1755098784/qhdjxx3v1xynhdhzrj1e.png', highlight: 'Semi-Automatic' }
  ],
  'case-packers': [
    { name: 'ICP-120', title: 'ICP-120 Automated Case Packer for Pouches', subtitle: 'Robotic Case Packer', href: '/products/case-packers/icp-120', image: 'https://res.cloudinary.com/dbogkgabu/image/upload/v1752945423/icp-120_c9k0w8.png', highlight: 'Automated' },
    { name: 'ICS-200', title: 'ICS-200 Automated Case Packer for Strip Pouches', subtitle: 'Strip Processing System', href: '/products/case-packers/ics-200', image: 'https://res.cloudinary.com/dbogkgabu/image/upload/v1755098778/icqycnzcjm2caqhemj5x.png', highlight: 'Strip Processing' },
    { name: 'ICB-120', title: 'ICB-120 Case Packer for Bottles', subtitle: 'Bottle Packing Solution', href: '/products/case-packers/icb-120', image: 'https://res.cloudinary.com/dbogkgabu/image/upload/v1752945429/ICB120_case_packer_bottles_mqhvdm.png', highlight: 'Bottle Packing' },
    { name: 'Case Erector', title: 'Automatic Case Erectors', subtitle: 'Case Formation System', href: '/products/case-packers/case-erector', image: 'https://res.cloudinary.com/dbogkgabu/image/upload/v1755098774/nu2tjyq4jfbjxoeisycb.png', highlight: 'Case Formation' },
    { name: 'Case Sealer', title: 'Automatic Case Sealers', subtitle: 'Sealing & Closing System', href: '/products/case-packers/case-sealer', image: 'https://res.cloudinary.com/dbogkgabu/image/upload/v1755098775/lphxuwk9yeykyaojtmxx.png', highlight: 'Sealing' }
  ],
  'checkweighers': [
    ...
    { name: 'ICW-6000', title: 'ICW-6000 Heavy Duty Checkweigher', subtitle: 'Heavy Duty 1.2kg-6kg', href: '/products/checkweighers/icw-6000', image: 'https://res.cloudinary.com/dbogkgabu/image/upload/v1755178600/h99w6hq4fzdkuwv0mitr.png', highlight: 'Heavy Duty' },
    { name: 'ICW-25K', title: 'ICW-25K Industrial Checkweigher', subtitle: 'Industrial 6kg-25kg', href: '/products/checkweighers/icw-25k', image: 'https://res.cloudinary.com/dbogkgabu/image/upload/v1755098779/to7gc0wb5jq8dzm3bojs.png', highlight: 'Industrial' },
    { name: 'ICW-50K', title: 'ICW-50K Extra Heavy Checkweigher', subtitle: 'Extra Heavy 25kg-50kg', href: '/products/checkweighers/icw-50k', image: 'https://res.cloudinary.com/dbogkgabu/image/upload/v1755098779/qwdbgrhu0duvwvui6i3t.png', highlight: 'Extra Heavy' }
  ],
  'checkweighers-inspection': [
    ...
    { name: 'ICW-6000', title: 'ICW-6000 Heavy Duty Checkweigher', href: '/products/checkweighers-inspection', image: 'https://res.cloudinary.com/dbogkgabu/image/upload/v1755178600/h99w6hq4fzdkuwv0mitr.png', highlight: 'Heavy Duty' },
    { name: 'ICW-25K', title: 'ICW-25K Industrial Checkweigher', href: '/products/checkweighers-inspection', image: 'https://res.cloudinary.com/dbogkgabu/image/upload/v1755098779/to7gc0wb5jq8dzm3bojs.png', highlight: 'Industrial' },
    { name: 'ICW-50K', title: 'ICW-50K Extra Heavy Checkweigher', href: '/products/checkweighers-inspection', image: 'https://res.cloudinary.com/dbogkgabu/image/upload/v1755098779/qwdbgrhu0duvwvui6i3t.png', highlight: 'Extra Heavy' },
