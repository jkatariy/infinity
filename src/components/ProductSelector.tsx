...
const productCategories = {
  ...
  'checkweighers': {
    title: 'Checkweighers',
    models: [
      { name: 'ICW-600 Light Duty Checkweigher', href: '/products/checkweighers/icw-600', shortName: 'ICW-600' },
      { name: 'ICW-1200 Standard Checkweigher', href: '/products/checkweighers/icw-1200', shortName: 'ICW-1200' },
      { name: 'ICW-6000 Heavy Duty Checkweigher', href: '/products/checkweighers/icw-6000', shortName: 'ICW-6000' },
      { name: 'ICW-25K Industrial Checkweigher', href: '/products/checkweighers/icw-25k', shortName: 'ICW-25K' },
      { name: 'ICW-50K Extra Heavy Checkweigher', href: '/products/checkweighers/icw-50k', shortName: 'ICW-50K' },
      { name: 'ICW Series (All Models)', href: '/products/checkweighers/icw-series', shortName: 'ICW Series' }
    ]
  },
  'inspection': {
    title: 'Inspection Systems',
    models: [
      { name: 'Vision Inspection Systems', href: '/products/inspection/vision-systems', shortName: 'Vision Systems' }
    ]
  },
  'conveying': {
