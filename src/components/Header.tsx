  ...
  const navItems: MenuItem[] = [
    ...
    },
    {
      ...
      submenu: [
        ...
        {
          name: 'Checkweighers',
          href: '/products/checkweighers',
          submenu: [
            { name: 'Check Weighers (ICW-600/ICW-1200/ICW-6000/ICW-25K/ICW-50K)', href: '/products/checkweighers/icw-series' }
          ]
        },
        {
          ...
          submenu: [
            { name: 'Automated Vision Inspection Systems', href: '/products/inspection/vision-systems' }
          ]
        },
        {
      ...
      submenu: [
        {
          ...
          submenu: [
            { name: 'Secondary Packaging (IBP-120)', href: '/products/bundling-wrapping/ibp-120' },
            { name: 'Shrink Wrapping (ISP-120)', href: '/products/bundling-wrapping/isp-120' },
            { name: 'Cartoning (ACM-100)', href: '/products/cartoning/acm-100' },
        ...
        },
        {
          ...
          submenu: [
            { name: 'Secondary Packaging (IBP-120)', href: '/products/bundling-wrapping/ibp-120' },
            { name: 'Bottle Wrapping (IWB-200)', href: '/products/bundling-wrapping/iwb-200' },
            { name: 'Case Packing (ICB-120)', href: '/products/case-packers/icb-120' },
            { name: 'Vision Inspection', href: '/products/inspection/vision-systems' }
          ]
        },
        {
