...
const solutions = [
  ...
  },
  {
    ...
    description: 'Advanced vision inspection systems for pharmaceutical quality control and compliance.',
    features: [
    ...
    image: '/images/products/vision-systems.jpg',
    href: '/products/inspection/vision-systems'
  },
  {
    name: 'Checkweighing (ICW Series)',
    description: 'High-precision checkweighing systems for pharmaceutical weight verification.',
    features: [
      'High accuracy ±0.01g',
    ...
    href: '/products/checkweighers/icw-series'
  },
  {
