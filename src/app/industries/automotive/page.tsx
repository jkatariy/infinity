...
const solutions = [
  ...
  },
  {
    ...
    description: 'Advanced vision systems for automotive part quality control.',
    features: [
      'Part verification',
      'Surface inspection',
      'Dimensional checks',
  ...
  {
    name: 'Heavy Checkweighing',
    description: 'High-capacity weighing systems for automotive components.',
    features: [
      'High accuracy',
      'Large part handling',
      'Data tracking',
