...
const solutions = [
  ...
  },
  {
    ...
    description: 'High-precision checkweighing systems for food safety and compliance.',
    features: [
    ...
    href: '/solutions/checkweighers/icw-series'
  },
  {
    name: 'Vision Inspection',
    description: 'Advanced vision inspection systems for food quality and safety.',
    features: [
    ...
    href: '/solutions/inspection/vision-systems'
  }
];
