...
const productCategories = [
  ...
  {
    title: 'Check Weighing Systems',
    description: 'High-precision weighing systems for quality control with 10g to 50kg capacity',
    models: ['ICW-600', 'ICW-1200', 'ICW-6000', 'ICW-25K', 'ICW-50K'],
    href: '/products/checkweighers',
    icon: '⚖️',
    color: '#0EA5E9',
    stats: '5 Models | 10g-50kg Range',
    highlight: 'Quality Control'
  },
  {
    title: 'Vision Inspection Systems',
    description: 'Advanced automated vision inspection for quality assurance and defect detection',
    models: ['Vision Systems'],
    href: '/products/inspection',
    icon: '👁️',
    color: '#DC2626',
    stats: '1 System | AI-Powered',
