...
const staticPages = [
  ...
  '/products/checkweighers',
  '/products/checkweighers/icw-1200',
  '/products/checkweighers/icw-25k',
  '/products/checkweighers/icw-50k',
  '/products/checkweighers/icw-600',
  '/products/checkweighers/icw-6000',
  '/products/checkweighers/icw-series',
  '/products/conveying',
  '/products/conveying/box-lifter',
  '/products/conveying/compression-conveyor',
  '/products/conveying/crate-lifter',
  '/products/conveying/flat-belt',
  '/products/conveying/modular-conveyor',
  '/products/conveying/roller-conveyor',
  '/products/conveying/spiral-conveyor',
  '/products/conveying/z-bucket-elevator',
  '/products/inspection',
  '/products/inspection/vision-systems',
